 ...
 */
export function getScraperConfig(source) {
...
export function getEnabledScrapers() {
    return Object.values(LeadSource).filter((source) => scraperConfigs[source].enabled);
}
//# sourceMappingURL=scrapers.config.js.map