...
export class ProxyRotator {
    ...
    markFailure(proxy) {
        proxy.failCount++;
        logger.debug(`Proxy ${proxy.url} failed (${proxy.failCount}/${proxy.successCount + proxy.failCount} requests)`);
    }
    /**
 ...
 */
export function initProxyRotator(proxyUrls, config) {
    defaultRotator = new ProxyRotator(config);
    defaultRotator.addProxies(proxyUrls);
    return defaultRotator;
}
//# sourceMappingURL=proxy-rotator.js.map